...
*/
/*
var biggerTwo = function(array1, array2){
    var sum1=0;
    var sum2=0;
...
*/
/*
var swapEnds = function(array){
   var tempElem;
    tempElem=array[0];
    array[0]=array[array.length-1];
    array[array.length-1]=tempElem;
    console.log(array);
}
swapEnds([1, 2, 3, 4])// -> [4,2,3,1];
swapEnds([1, 2, 3])// -> [3,2,1]
...
//var sum67 = function(array){
//    var sum=0;
//    for(var i=0; i<array.length; i++){
//        if(array[i]==6){
//            find6=i;
//            for(var j=find6; j<array.length; j++){
//                if(array[j]==7){
//                  array[j]=0;
//                    break;
//                }
...
sum67([1, 1, 6, 7, 2,4,7]); //->4
sum67([1, 1, 6, 2,5,7,2,6,2,7,2,2,6]); //->2
